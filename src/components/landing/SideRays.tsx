...
// Effet de fond décoratif pour le Hero — rayons WebGL discrets partant d'un
// coin de l'écran. Lazy : ne s'initialise (contexte WebGL + boucle de rendu)
// que lorsque le conteneur entre dans le viewport, et se nettoie proprement
// au démontage pour ne pas laisser de contexte GL ou de rAF actifs en arrière-plan.
const SideRays = ({
  speed = 2.5,
  rayColor1 = '#EAB308',
  rayColor2 = '#96c8ff',
